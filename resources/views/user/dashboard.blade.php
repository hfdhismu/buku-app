    ...
    <div class="container mt-4">
        ...
        <div class="mt-5">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body">
                    <h5 class="fw-bold mb-3">📖 Riwayat Peminjaman</h5>
                                ...
                                <tbody>
                                    @foreach($riwayatPeminjaman as $index => $p)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-{{ is_null($p->tanggal_kembali) ? 'warning' : 'success' }}">
                                                    {{ is_null($p->tanggal_kembali) ? 'Dipinjam' : 'Dikembalikan' }}
                                                </span>
                                            </td>
                                        </tr>
                                    @endforeach
